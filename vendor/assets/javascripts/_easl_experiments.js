...
function init() {
	...
	imagequeue.loadManifest([
       {id: "IED", src:"./media/icons/IED.png"},
	   {id: "IED_icon", src:"./media/icons/IED_icon.png"},
	   {id: "NO", src:"./media/icons/no_symbol.png"},
	   {id: "Line", src:"./media/icons/line.png"},
	   {id: "Line_icon", src:"./media/icons/line_icon.png"},
	   {id: "Text", src:"./media/icons/textbox.png"},
	   {id: "Text_icon", src:"./media/icons/textbox_icon.png"},
	   {id: "GE_WiYZ", src:"./media/icons/GE_WiYZ.png"},
	   {id: "GE_WiYZ_icon", src:"./media/icons/GE_WiYZ_icon.png"},
	   {id: "esprit_cam", src:"./media/icons/esprit_cam.png"},
	   {id: "esprit_cam_icon", src:"./media/icons/esprit_cam_icon.png"},
	   {id: "Switch", src:"./media/icons/Switch.png"},
	   {id: "Switch_icon", src:"./media/icons/Switch_icon.png"},
	   {id: "circle", src:"./media/icons/circle_icon.png"},
	   {id: "circle_icon", src:"./media/icons/circle_icon.png"}
    ]);
