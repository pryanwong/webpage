...
var jscolor = {
	...
	color : function(target, prop) {
		...
		// require images
		switch(modeID) {
			case 0: jscolor.requireImage('common/hs.png'); break;
			case 1: jscolor.requireImage('common/hv.png'); break;
		}
		jscolor.requireImage('common/cross.gif');
		jscolor.requireImage('common/arrow.gif');
